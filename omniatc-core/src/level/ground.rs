...
impl EntityCommand for SpawnSegment {
    fn apply(self, entity: Entity, world: &mut World) {
        ...
        world.entity_mut(entity).insert((
            self.segment,
            bevy::core::Name::new(format!("GroundSegment {:?}", &self.label)),
            self.label,
        ));
        world.send_event(SegmentChangedEvent(entity));
...
impl EntityCommand for SpawnEndpoint {
    fn apply(self, entity: Entity, world: &mut World) {
        world.entity_mut(entity).insert((
            ...
            bevy::core::Name::new("GroundEndpoint"),
        ));
        world.send_event(EndpointChangedEvent(entity));
    }
}
