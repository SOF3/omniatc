...
use bevy::math::Vec2;
use bevy::prelude::{
    Commands, Component, Entity, EntityCommand, IntoSystemConfigs, Query, Res, World,
};
use bevy::time::{self, Time};

use super::{nav, ResyncTrigger, SystemSets};
...
fn altitude_diff_system(
    ...
    object_query
        ...
        .for_each(|(object, _, _)| {
            commands.entity(object).queue(ResyncTrigger);
        });
}
