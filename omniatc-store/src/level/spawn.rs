...
use crate::{
    ...
    SegmentLabel, WaypointRef, WeightedList,
};
...
pub enum SpawnPosition {
    /// Objects created by this set will be spawned in a random ocupied apron in the aerodrome.
    Aprons {
    ...
    /// Objects created this set will be spawned on a taxiway next to a runway.
    Runway {
    ...
    /// Objects of this set will be spawned in the air near a waypoint.
    Airborne {
